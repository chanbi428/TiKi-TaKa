...
export const getToDoDate = (te) => {
  ...
  if (te[0][te[0].length - 1] == "년") {
    for (let j = 0; j < 3; j++) {
      if (te[j].length == 2|| (te[j].length == 3 && te[j][2] == "에")) tdate[j] += "0";
    ...
    for (let j = 1; j < 3; j++) {
      if (te[j-1].length == 2 || (te[j-1].length == 3 && te[j-1][2] == "에")) tdate[j] += "0";
      for (let i = 0; i < te[j].length; i++) {
    ...
    dt = 2;
  } else if ((te[0][te[0].length - 1] == "일"||(te[0][te[0].length - 2] == "일" && te[0][te[0].length - 1] == "에")) && (te[0] != "내일"||te[0]!="내일에")) {
    tdate[0] = today.getFullYear();
    tdate[1] = today.getMonth() + 1;
    for (let j = 2; j < 3; j++) {
      if (te[j-2].length == 2|| (te[j-2].length == 3 && te[j-2][2] == "에")) tdate[j] += "0";
      for (let i = 0; i < te[j].length; i++) {
